...
public class SaveLoadWWW : MonoBehaviour
{
	...
	public string myMapIDCode;						//example: gfdfghjke

	public string //http://citybuildingkit.com/
		serverAddress = "http://citybuildingkit.com/", // you must change these values in the GameManager > SaveLoadWWW for Game Scene and the Map01 SaveLoadBattle
		filesAddress = "get_match.php",//get_match.php?license=XXXXXXX
