...
public class SaveLoadBattle : SaveLoadBase {
	...
	private string 
		...
		fileExt = ".txt",
		myUseridFile,						//example: gfdfghjke.txt
		battleMapID,
	...
	public string 											//http://citybuildingkit.com/
		serverAddress = "http://citybuildingkit.com/",		// you must change these values in the GameManager > SaveLoadBattle for Map01 Scene
