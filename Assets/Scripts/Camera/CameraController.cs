...
public class CameraController : MonoBehaviour {
	...
	private Component relay, spriteLightKitCam;
	...
	void Start () 
	{
		...
		//SpriteLightKitCam = GameObject.Find("SpriteLightKit");
	}
	...
	private void UpdateSpriteLightKitCam()
	{
		...
		((tk2dCamera)spriteLightKitCam).ZoomFactor = ((tk2dCamera)this.GetComponent ("tk2dCamera")).ZoomFactor;
	}
