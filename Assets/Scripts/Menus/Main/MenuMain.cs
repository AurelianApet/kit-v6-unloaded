...
public class MenuMain : MonoBehaviour {											//manages major interface elements and panels
	...
	private const int 
		noAnchors = 7,//includes 3 fading "Plus buttons" + the day/night "clock"
		noPanels = 9,
	...
	public void OnCloseShop(){Panels[0].GetComponent<ShopPanelManager>().StopLateCoroutines(); OnDeactivatePanel (0);}
	...
	public void OnInvite(){OnActivatePanel (3);}
	public void OnCloseInvite(){OnDeactivatePanel (3);}

	public void OnPurchase(){OnActivatePanel (4);}
	public void OnClosePurchase(){OnDeactivatePanel (4);}

	public void OnUpgrade(){OnActivatePanel (5);}
	public void OnCloseUpgrade(){OnDeactivatePanel (5);}
	...
	public void OnCloseUnits(){OnDeactivatePanel (6);}

	public void OnDamage(){OnActivatePanel (7);}
	public void OnCloseDamage(){OnDeactivatePanel (7);}
	...
	private void TweenAnchors()
	{
		...
		{
			if(i!=2)//skip the top right anchor for children tween position
